...
def create_task(task):
    ...
    additional_task = input("Press 1 to add another Task, Press any other key if you are done:")
...
def delete_task(task):
    ...
    if delete_confirmation == "Y" or delete_confirmation == "y":
        ...
        for i in todo_list:
            print (str(todo_list.index(i)+1)+". " + i)
        other =input("Press 1 to delete another task, Press any other key if you are done:")
        if other == "1":
...
def mark_as_finished(task):
    ...
    for i in todo_list:
        print (str(todo_list.index(i)+1)+". " + i)
    mark_other =input("Press 1 to mark another task, Press any other key if you are done:")
    if mark_other == "1":
